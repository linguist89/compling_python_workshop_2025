...
1. Create a function that converts a list of user data into a dictionary:
...
2. Create a function that handles bad user data:
...
3. Create a function that processes files in a directory:
